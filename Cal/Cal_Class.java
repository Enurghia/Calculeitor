...
public class Cal_Class {
	...
	public static void cal_Prom () {
		...
		boolean aux = true;
		boolean Taux = true;
		//Ciclo iterativo para decidir el tipo de promedio que se usará
		while(Taux == true){
			System.out.print("Ingrese la operación."+"\n"+"	1) Promedios sin ponderación."+"\n"
			...
			case "1":
				...
				break;
			case "2":
				//Inicio determinando la cantidad de notas y la ponderación de cada una
				while(aux == true){
				System.out.print("Ingrese la cantidad de notas del estudiante."
						+"\n"+"Tras ingresar la cantidad de nota presione [ENTER]"
						+"\n"+"Ingrese [0] y pulse [ENTER] para"
					...
					if((int)Prom.Delta(B) == 0){
						...
						for(int i = 0; i < Prom.Delta(B); i++){
							System.out.println("Ingrese la ponderación de la nota número "+(i+1)+"."
								+"\n"+"Queda el "+pon+"% de la ponderación disponible"+"\n"
								+"Tras ingresar una ponderación, pulse [ENTER] para continuar");
							System.out.print("---------------------------------------------------"+"\n");
							if(i != (Prom.Delta(B)-1)){
								C = sc.next();
								if((Prom.Delta(C)<0)||(Prom.Delta(C)>pon)) {
									i--;
									System.out.println("Esa ponderación no es válida.");
									System.out.print("---------------------------------------------------"+"\n");
								}
								else {
									if(Prom.Delta(C) == 100) {
				...
				System.out.print("---------------------------------------------------"+"\n");
					...
					case "1":
						System.out.print("Ingrese la cantidad de valores a ordenar"
							+" y pulse [ENTER]"+"\n"+"(Si ingresa letras, serán ignoradas)"+"\n");
				System.out.print("---------------------------------------------------"+"\n");
						option = sc.next();
						...
						System.out.print("Ingrese la cantidad máxima que puedan tomar los valores"
								+" y pulse [ENTER]"+"\n"+"(Si ingresa letras, serán ignoradas)"+"\n");
				System.out.print("---------------------------------------------------"+"\n");
						option = sc.next();
						j = (int)Prom.Delta(option);
